...
<legend><?php echo JText::_('Editor'); ?></legend>
		...
		<p>
         <button type="submit" onclick="submitbutton('save')"><span class="round"><span><?php echo JText::_('Save') ?></span></span></button>
         
          <button type="submit" onclick="submitbutton('cancel')"><span class="round"><span><?php echo JText::_('Cancel') ?></span></span></button>
