	...
	<div id="templateslist" style="text-align: left;">
		<table id="templates" class="adminlist">
			...
			foreach ($this->templateslist as $id => $details) {
				...
				/* Edit button */  ?>
				<td>
					<?php echo JHTML::_('link', $_SERVER['PHP_SELF'], '<img src="'.JURI::root().'administrator/components/com_csvimproved/assets/images/edit_16.png" alt="'.JText::_('EDIT').'" />', 'onClick="document.adminForm.cb'.($i-1).'.checked = true; submitbutton(\'fieldstemplate\'); return false;"');?>
				</td>
				</tr>
				<?php
			}
