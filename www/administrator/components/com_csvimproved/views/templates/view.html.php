 ...
 * @version $Id: view.html.php 903 2009-05-14 15:47:24Z Roland $
 */
...
class CsvimprovedViewTemplates extends JView {
	...
	function toolbar() {
		switch (JRequest::getCmd('task')) {
			case 'newtemplate':
				JToolBarHelper::title(JText::_('New template'), 'csvi_new_48');
				JToolBarHelper::custom('save', 'csvi_save_32', 'csvi_save_32', JText::_('Save'), false);
				JToolBarHelper::custom('cancel', 'csvi_cancel_32', 'csvi_cancel_32', JText::_('Cancel'), false);
				break;
			case 'edittemplate':
				JToolBarHelper::title(JText::_('Edit template'), 'csvi_edit_48');
				JToolBarHelper::custom('save', 'csvi_save_32', 'csvi_save_32', JText::_('Save'), false);
				JToolBarHelper::custom('cancel', 'csvi_cancel_32', 'csvi_cancel_32', JText::_('Cancel'), false);
				break;
			default:
				JToolBarHelper::title(JText::_('Templates'), 'csvi_templates_48');
				JToolBarHelper::custom('newtemplate', 'csvi_new_32', 'csvi_new_32', JText::_('New'), false);
				JToolBarHelper::custom('edittemplate', 'csvi_edit_32', 'csvi_edit_32', JText::_('Edit'), true);
				JToolBarHelper::custom('clonetemplate', 'csvi_clone_32', 'csvi_clone_32', JText::_('Clone'), true);
				JToolBarHelper::custom('deletetemplate', 'csvi_delete_32', 'csvi_delete_32', JText::_('Delete'), true);
				JToolBarHelper::divider();
				JToolBarHelper::custom('fieldstemplate', 'csvi_fields_32', 'csvi_fields_32', JText::_('Fields'), true);
				break;
		}
	}
