...
class CsvimprovedViewMaintenance extends JView {
	 ...
	 */
	function toolbar() {
		JToolBarHelper::title(JText::_('Maintenance'), 'csvi_maintenance_48');
		if (!JRequest::getBool('boxchecked')) JToolBarHelper::custom('maintenance', 'csvi_continue_32.png', 'csvi_continue_32.png', JText::_('CONTINUE'), true );
	}
}
?>
