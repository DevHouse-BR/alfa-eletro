...
class CsvimprovedViewTemplateFields extends JView {
	 ...
	 */
	function toolbar() {
		JToolBarHelper::title(JText::_('Template fields'). '::'.$this->template->template_name, 'csvi_fields_48');
		JToolBarHelper::custom( 'templates', 'csvi_templates_32', 'csvi_templates_32', JText::_('Templates'), false);
		JToolBarHelper::custom( 'publish', 'csvi_publish_32', 'csvi_publish_32', JText::_('Publish'), true);
		JToolBarHelper::custom( 'unpublish', 'csvi_unpublish_32', 'csvi_unpublish_32', JText::_('Unpublish'), true);
		JToolBarHelper::custom( 'savefieldstable', 'csvi_save_32', 'csvi_save_32', JText::_('Save'), false);
	}
