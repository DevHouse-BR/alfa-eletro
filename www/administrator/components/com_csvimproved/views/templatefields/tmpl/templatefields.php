 ...
 * @version $Id: templatefields.php 907 2009-05-22 15:26:28Z Roland $
 */
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<?php if (stristr($this->template->template_type, 'export')) {?>
			...
			<tr class="row0">
				<td class="center"><input type="text" name="field[{fill}][_order]" value="<?php echo count($this->fields)+1; ?>" size="4" /></td>
				<td>
				...
				<td class="center"><?php echo JHTML::_('link', JRoute::_('index.php?option=com_csvimproved&controller=templates&task=fieldstemplate&template_id='.$this->template_id), '<img src="'.JURI::root().'administrator/components/com_csvimproved/assets/images/add_32.png" width="20" height="20" alt="'.JText::_('Add').'" />', 'onClick="document.adminForm.task.value = \'addfield\';document.adminForm.submit();return false;"'); ?></td>
			</tr>
			...
			<tr>
				...
				<th width="10%" class="title"><?php echo JText::_('Field ordering'); ?> <a href="index2.php" onclick="document.adminForm.task.value='renumber'; document.adminForm.submit(); return false;"><img src="<?php echo JURI::root().'administrator/components/com_csvimproved/assets/images/order_16.png'; ?>" alt="<?php echo JText::_('Renumber');?>" title="<?php echo JText::_('Renumber');?>"></a></th>
			...
			for ($i=0, $n=count($this->fields); $i < $n; $i++) {
				...
				<a href="index.php" onClick="document.adminForm.cb<?php echo $i;?>.checked = true; document.adminForm.task.value='deletefield'; document.adminForm.submit(); return false;">
                    <img src="<?php echo JURI::root().'/administrator/components/com_csvimproved/assets/images/delete_32.png'; ?>" width="20" height="20" border="0" alt="<?php echo $alt; ?>" />
                </a>
				</td>
				</tr>
				<?php
