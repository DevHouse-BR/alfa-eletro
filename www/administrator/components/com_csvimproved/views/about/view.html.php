...
class CsvimprovedViewAbout extends JView {
	 ...
	 */
	function toolbar() {
		JToolBarHelper::title(JText::_('About'), 'csvi_about_48');
		$bar = JToolBar::getInstance('toolbar');
		$bar->appendButton( 'Popup', 'csvi_key_32', 'Preferences', 'index.php?option=com_config&amp;controller=component&amp;component=com_csvimproved', 670, 200 );
	}
}
?>