 ...
 * @version $Id: install.csvimproved.php 908 2009-05-22 15:49:13Z Roland $
 */
...
function com_install() {
	...
	$q = "INSERT IGNORE INTO `#__csvi_available_fields` (`csvi_name`, `vm_name`, `vm_table`) VALUES
			...
			('discount_with_tax', 'discount_with_tax', 'productexport'),
	...
	<br />
	<?php if ($error) { ?>
		CSV Improved 1.7 installation reported errors.
	<?php }
	else { ?>
		CSV Improved 1.7 has been succesfully installed.
	<?php } ?>
	<br /><br />
	<!-- <div style="color: #FF0000; font-weight: bold; font-size: 18px; text-align: center;">THIS IS BETA</div> -->
		Start using <?php echo JHTML::_('link', JURI::root().'administrator/index.php?option=com_csvimproved', 'CSV Improved'); ?>
		<br /><br />
