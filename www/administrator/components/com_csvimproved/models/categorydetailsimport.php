 ...
 * @version $Id: categorydetailsimport.php 907 2009-05-22 15:26:28Z Roland $
 */
	...
	public function getProcessRecord() {
		...
		if ($template->thumb_create) {
			...
			if (isset($this->category_full_image) && isset($this->category_thumb_image)) {
				$file_details = $this->_importmodel->ProcessImage($this->category_full_image, $this->category_thumb_image);
			}
			else {
		...
		if (!$categoryid) {
			...
			$this->category_id = $categoryid['category_id'];
			$this->mdate = time();
		}
