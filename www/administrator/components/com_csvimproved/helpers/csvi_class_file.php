 ...
 * @version $Id: csvi_class_file.php 903 2009-05-14 15:47:24Z Roland $
 */
	...
	function ReadNextLine() {
		...
		switch ($this->extension) {
			case 'csv':
				...
				if (!empty($template->text_enclosure)) $csvdata = fgetcsv($this->fp, 16384, $field_delimiter, $template->text_enclosure);
				else $csvdata = fgetcsv($this->fp, 16384, $template->field_delimiter);
