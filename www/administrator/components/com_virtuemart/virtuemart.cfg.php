...
if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	...
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/classic_1/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/classic_1/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/classic_1/' );
...
define('PSHOP_OFFLINE_MESSAGE', 'Nossa loja está atualmente fechada para manutenção. Por favor, volte mais tarde.');
...
define('DOWNLOADROOT', 'E:\home\alfaeletro\web/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '5f3b274249be1b13d018fb9974a5c35b');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
