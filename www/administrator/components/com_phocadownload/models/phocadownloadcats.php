...
class PhocaDownloadCpModelPhocaDownloadcats extends JModel
{
	...
	function __construct()
	{
		parent::__construct();
		global $mainframe;
		$context	= 'com_phocadownload.category.list.';		
	...
	function _buildQuery() {
		...
		$orderby	= $this->_buildContentOrderBy($context, 'cc.section');
	...
	function _buildContentOrderBy($context, $cc_or_a) {		
	...
	function _buildContentWhere($context)
	{
		...
		$filter_order		= $mainframe->getUserStateFromRequest( $context.'filter_order',		'filter_order',		'cc.ordering',	'cmd' );
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( $context.'filter_order_Dir',	'filter_order_Dir',	'',				'word' );
